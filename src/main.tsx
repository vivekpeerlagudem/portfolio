...
console.log('%c I build the details. Let\'s solve something hard → hi@vivekpeerlagudem.com ', 'background: #f97316; color: #1a1a1a; font-size: 13px; font-weight: bold; padding: 4px 8px; border-radius: 3px;')
...
function NotFound() {
  useEffect(() => {
    ...
    document.title = '404 — Page not found | vivekpeerlagudem'
